...
int main ()
{
  ...
  std::string protocol = "TcpNewReno1";
  std::string lat = "2ms";
...
//*********************IP addresses Setup******************************************
  ...
  //TypeId tid = TypeId::LookupByName ("ns3::TcpTahoe");	  // Test Purposes
...
//Config::SetDefault ("ns3::TcpL4Protocol::SocketType", StringValue (ns3::TcpTahoe.str ()));
  ...
  app2->Setup (ns3TcpSocket2, sinkAddress, 1040, 100000, DataRate ("1Mbps"));
